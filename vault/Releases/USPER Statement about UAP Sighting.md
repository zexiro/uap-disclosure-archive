...
![[usper-statement-redacted.jpg]]

## Files

- [Local: usper-statement-redacted.pdf](../../raw/docs/usper-statement-redacted.pdf)
- [Source: war.gov](https://www.war.gov/medialink/ufo/release_1/usper-statement-redacted.pdf)
...
At 1751 hours      [CALL SIGN 1] s p o t t eed -
                                             cavern
                                                 larentrance ([COORDINATES])
and conducted a short orbit of the location

At a     roximately 2050 hours-[CALL SIGN 1] landed west of t h ~
...
brieflY. landed at [SITE CODE NAME] to await refueling but then lifted off and retu rned
to the
...
At approximately 2149 hours, [CALL SIGN 1) departed the search location to retu rn to
base and received notification from LP/OP that - h a d - h i t s bearing -          4
...
[WITNESS 1] ( n a ~ i l o t s (NVG) spotted a swarm of lights moving in all
...
~ e l y 2306 hours                   [CALL SIGN 1]
-          At 2316 hour               low on fuel, [CALL SIGN 1] returned to the
[OPERATIONS CENTER].

At approximately 2320 hours   Ill
                                [CALL SIGN 1] headed southbound for the
...
Some things I could not see with the naked eye, but I recall the pilots call ing out
sightings.
