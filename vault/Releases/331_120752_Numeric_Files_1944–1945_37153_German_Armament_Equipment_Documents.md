...
source_urls: ["https://www.war.gov/medialink/ufo/release_1/331_120752_numeric_files_1944–1945_37153_german_armament_equipment_documents.pdf"]
---
...
![[331_120752_numeric_files_1944_1945_37153_german_armament_equipment_documents.jpg]]

## Files

- [Local: 331_120752_numeric_files_1944_1945_37153_german_armament_equipment_documents.pdf](../../raw/docs/331_120752_numeric_files_1944_1945_37153_german_armament_equipment_documents.pdf)
- [Source: war.gov](https://www.war.gov/medialink/ufo/release_1/331_120752_numeric_files_1944–1945_37153_german_armament_equipment_documents.pdf)
...
SUPRSMS HEADQUART uRS
® ALLIS) SXPENITIONARY FORCS (FORWARD)
Office of the Assistant Chief of staff \=-2

2 SF : SHASF/AIR/S37183/A-2 ; 14 March 1946.

SUBJSCT: Request for Photographs.
)
TO b HQ. 1ST US. TAC. A.F. Y
...
FROM ame StaFF, SSADF. (FORWARD) a
We AIR MONISTRY, WHITEHAIL.
"REPEATED Y ni
~~ S nv oes Nuniber Date (Wetle hosizoutaily) 7
Bel, SEL" (5 MARCH 19,5.) -SEeRetY. YOUR AX 222 | 4d -MAROH(.)
_UNDERSTAMD | prow ppi2 VISITIT TERE TODAY iT ALL 10—
_ AVAILABLE... | BOR TORPEDOES. PROS TRIPPELWERKE 15
| _MOLSUET «| Hay LSenny | BER. Sier O seen HC, ) DDI2. 20
won omen. |r em _ussmar am | perorr on | RE TO 25
30
bos is a 35
oe i ol srk 40
i 45
d 7 : a:
Goer me die ai) BHA Siocal Matto Sendin CYPHER *(1) By ANY Sigaal | Date-Time Group
*(2) NOT by Wireless (2) seat nae 05 f Jee a.
#(3) But if-tiable to Interception {

Ree sas creat aan ie {
_ Signature ee 4
...
Rank. “ asic,
(* Strive out methods which do not apply. Below this line is for Sisastets use only )
Systeto |-Time Systera | Time |.
int iis Reader Sender out out Reader Sender
...
——
Of ATR MINISTRY WHITEHALL

e

>

ABLE XRAY TWO TWO TWO TOURTH MARCH -SHoRe? ED

REFERENCE MIKESUGARWILLIAN SIX DATED SECOND JAUUARY ONENINEFOURFIVE FROM VCAS
...
TO ATR MARSHAL ROBB STRESSING IMPORTANCE OF RECOT TERING BULK

BOMB TORPEDOES FROM TRIPPELVERKE MOLSHETM AND REPLY JIG MIKES ROGER SLANT

ONE TWO TWO DATED SECOND JANUARY BULK DELIVERIES HAVE NOT REPEAT NOT YEE

4 jee |

BEGUN ED PIEASE INVESTIGATE AS STOCKS ARE REQUIRED URGENTLY.

} action .NFOR.
ey A-2
a | iy Gere a a
PRIOZITY IMPORTANT a 2 3 6 f) GR = a 2 “% ;
fi 1 | i ist, :
_ ee ee — ee a
...
| —£ patted:
Seay Lat) | |
SFY JEZO NR-ETS 21 OPOR . 2 ES

FROM$ HQ IX TAC 951192A
TOs AIR STAFF SeHeAcEsFe FORWARD

-SEGREF QQY BT

REFERENCE YOUR MESSAGE Ale329 DATED @41745A% PHOTOS OF LONG CYLINDRICAL
...
; ‘(Above thus ine ts Lor Signals use only)
FROM — sTR SOAR S.H.A.E.F. FORWARD.

TO WHET 7, ib
AR manrstey.  usstar.(/Y/ona 0.A.F/ /\s0 wAC ALB, 11.Q. DOH TAC,

~~ REPEATED a

NINTH ATR FORCE. (

SSeS Number Date (Weate horizontally) % z
PAT. |. 3207 4 MARCH 19%.5 [| FOLLOWING RECELVED FROM H.Q. MaNTH 5
_TAC ATR COMMAND | DATED 1 MARCH QUOTE PILOTS | REPORT FOLLOWING, AN ALUM 10
_ COLOURED _. | ome SHAPED OBJECT | C@MMA ABOUT 12 | FEET LONG 15
AND 1_FooT TN. | DIAMETER WAS | __ OBSERVED | RLOATING INTHE | ATR Ap 20
9,000 FEET ({) | 17 APPEARED 10 BE “SUSPENDED | WmRTIcALEY | 25
_WITH SMALL FINS AND A | | aus? PROJECTING FROM| THE LOWER 30
END ‘(.)__‘THR!_| OBJECT WAS ATTACKED AND | PARTIALLY DEFLATED 35»
COMMA _A RED FLANE RESULTED | WITHOUT SMOKE | (.)! THE cynmmer 49
_ _DID_Nor, DISINTECRATE (.)..PHOTO | TAKEN By A LOTISQ: 45
’ NA y ’
oF 67 TAC/R GROUP AT. 011030 HOURS | VIC F-5710 UNQUOTE (.) 50
May be sent AS WRITTEN 4(1) By ANY Signal Method — {Sendin CYP. HER on) By ANY Signal Dave-Time Group: ©
*(2) NOT by Wireless Method | * en
(3) But if liable to Interception iy *(@ NOT by Wireless ’
) _ or Capture SEND in CYPHER 23 6 9 (Gysgenstoveiinstcucnenal
Signature ! Cai pose ASO aN ( EDiA ot TE
Rank z Wank. 7
, 5 (7 Strike out methods which do net apply. Below this line is for Stents use only )
Se i iReader ites Spaeth Hl) reat ty | poate Wy Reade cae

iv 724899 Wt. 49887 /03734 497,000 Pads 3/44 MP 51-8336 «
R.A.F. Form 96. i» MES SA GE FOR M | tenal Otfice File No. Mat
CAN ~ No. of Office Date Stamp
& Groups
Messace GR
OUT ORCL A) coe
fleADING
Above Uus linc us lor Signats use galy :
FROM .
TO | Sat
‘ - PAGE 2 -

REPEATED }
pone oe's Number Date (Wrate horizontally) : 5
ee dari 1. MARCH |
_PHOTOS _10 AIR MINISTRY COMMA USSTAF Anps |) AsG.7,0, | 0
ALSO FULL WRITTEN REPORT BY PILOTS CONCERNED _ 19.
—(.) _ANY | FURTHER __ |. _TNSTANCES. _ALSO. TO. _EE 0
REPORTED (4): es
...
Send in CYPHER.*t) By ANY

Sissial
“Method

Rank Iytantc ai,
; (rr * Strike out methods which do net apply. Below this line is for Signals use only )
System ‘| Time ‘ System | Tune . System | Time
in in Reader Sender out out Reader Sender out - out Reader
...
724899 Wt. $9687/03734 497,000 Pads 3/44 MP 51-8336 —
v ‘seentr SHAEF

STAFF MESSAGE CONTROL

Qc =2MARI945
: HQ Ik TAC SIGNED QUESADA 341S>

TH AR ADV A

uo) :GG SHAEF MAIN ATTN A~2,).CG NIN
...
An aluminum colored ¢
servea floating in the

about 12 ft long and 1 ft in diameter was ©
...
Photo taken by 107 SQ of 67 WAC/K Group at 011030

hours vie F-5710,
AIR STAPF we

AORION :
INFORMATION G-2 Pill |_ Atr_sté<——
SHAEF FORWARD IDiIsnRIBoMOs
...
2364 eS
1 MAR 45 22008 AGD/ml REF NO; NONS

oh 2 —_

JHE MAKING OF AN EXACT COPY OF THIS MESSAGE IS FORBIDDEN

SMC

A... A.D.1.(K), Air Ministry.

Tos~  A/Cdr, Grierson, S.H.A.E.F,Main,
Air Div.).
...
& AIR STAFF
t schamn HEADQUARTERS
; ALLIED RE POI PiCuARY FORCE.

PEP; SHARP ATR/T8.372.53/A~2. 21 Feb
...
3 ALLIED EXPEDITIONARY FORCE Bus
°
Wyss i
REF: ~ 3 i 1l February 19.5.
...
= GAS sae
aT | S25 ONES ieee ® oA uel
4 OQloen re & Ar Sa Q a

HEADQUARTERS XII TACTICAL ATR COMMAND (ADV), APO #574, U.S. ao
...
HEADQUARTERS XII TACTICAL AIR COMMAND (ADV) D-CG-1
